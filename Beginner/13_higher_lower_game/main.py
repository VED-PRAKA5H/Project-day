...
def higher_lower():
    ...
    score = 0
    while 5 > 4:
        print(f"Compare A: {data_of_celebs[n1]['Name']},"
              f" a {data_of_celebs[n1]['Profession']} from {data_of_celebs[n1]['Country']}.")
        print(logo2)
        print(f"Against B: {data_of_celebs[n2]['Name']},"
              f" a {data_of_celebs[n2]['Profession']} from {data_of_celebs[n2]['Country']}.")
        ...
        if user_answer == 'a' and compare_followers(pos1=n1, pos2=n2):
            ...
            n1 = n2
            n2 = random_celeb(n=n1)
        elif ((user_answer == 'a' and not compare_followers(pos1=n1, pos2=n2)) or
              (user_answer == 'b' and not compare_followers(pos1=n2, pos2=n1))):
